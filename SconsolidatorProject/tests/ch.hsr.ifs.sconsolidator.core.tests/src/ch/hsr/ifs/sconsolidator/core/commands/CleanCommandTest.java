...
public class CleanCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        cleanCommand = new CleanCommand(getSConsPath(), new NullConsole(), testProject.getProject(), projectSettingsStore);
    }
    ...
    public void testRun() throws Exception {
        ...
        new BuildCommand(getSConsPath(), new NullConsole(), testProject.getProject(), null, null).run(projectPath, new NullProgressMonitor());
