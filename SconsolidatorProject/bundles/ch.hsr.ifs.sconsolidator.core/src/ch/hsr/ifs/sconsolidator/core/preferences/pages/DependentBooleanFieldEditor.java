...
public class DependentBooleanFieldEditor extends BooleanFieldEditor {
    ...
    public DependentBooleanFieldEditor(BooleanFieldEditor dependencyFieldEditor, String name, String label, Composite parent) {
        super(name, label, parent);
        this.dependencyFieldEditor = dependencyFieldEditor;
    }

    public DependentBooleanFieldEditor(BooleanFieldEditor dependencyFieldEditor, String name, String labelText, int style, Composite parent) {
