...
public class SConsBuildTargetEventTest {
  ...
  public void before() {
    target =
        new SConsBuildTarget("CoastFoundationTest", null, "", "foundation tests", "--run-force");
  }

  @Test
  public void testCreate() {
    SConsBuildTargetEvent targetEvent =
        new SConsBuildTargetEvent(this, SConsBuildTargetEventType.PROJECT_ADDED, target);
