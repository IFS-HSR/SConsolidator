...
public class BuildTargetsPropertiesPage extends PropertyPage implements IWorkbenchPropertyPage,
    SConsBuildTargetListener {
  ...
  public BuildTargetsPropertiesPage() {
    this.defaultTargetImage =
        SConsImages.getImageDescriptor(SConsImages.DEFAULT_TARGET).createImage();
  ...
  private void createDefaultTargetButton() {
    defaultTargetButton =
        createNewButton(targetArea, SConsI18N.BuildTargetsPreferencePage_DefaultTargetButton);
  ...
  private void createDeleteTargetButton() {
    deleteTargetButton =
        createNewButton(targetArea, SConsI18N.BuildSettingsPreferencePage_RemoveTargetButton);
  ...
  private void createEditTargetButton() {
    editTargetButton =
        createNewButton(targetArea, SConsI18N.BuildSettingsPreferencePage_EditTargetButton);
  ...
  private void createAddTargetButton() {
    Button addTargetButton =
        createNewButton(targetArea, SConsI18N.BuildSettingsPreferencePage_AddTargetButton);
  ...
  private boolean confirmDelete() {
    ...
    String msg =
        NLS.bind(SConsI18N.DeleteTargetAction_ConfirmMessage, currentTarget.getDescription());
