...
public class SConsManagedNatureTest {
    ...
    public void testNatureAddAndRemove() throws Exception {
        ...
        new NatureUtil(project).addNature(SConsNatureTypes.MANAGED_PROJECT_NATURE.getId(), new NullProgressMonitor());
        ...
        new NatureUtil(project).removeNature(SConsNatureTypes.MANAGED_PROJECT_NATURE.getId(), new NullProgressMonitor());
