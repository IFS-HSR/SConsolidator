...
public class SConsExistingCodeNatureTest {
    ...
    public void testNatureAddAndRemove() throws Exception {
        ...
        new NatureUtil(project).addNature(SConsNatureTypes.EXISTING_CODE_PROJECT_NATURE.getId(), new NullProgressMonitor());
        ...
        new NatureUtil(project).removeNature(SConsNatureTypes.EXISTING_CODE_PROJECT_NATURE.getId(), new NullProgressMonitor());
