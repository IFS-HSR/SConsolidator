...
public class SConsExistingProjectHandler {
    ...
    private static final String    MANAGED_BUILD_NATURE  = "org.eclipse.cdt.managedbuilder.core.managedBuildNature";
    private static final String    SCANNER_CONFIG_NATURE = "org.eclipse.cdt.managedbuilder.core.ScannerConfigNature";
    ...
    public void configureProject(String wizardCmdArgs) throws CoreException {
        ...
        try {
            ...
            SConsPlugin.log(e);
            IStatus status = new Status(IStatus.ERROR, SConsPlugin.PLUGIN_ID, 0, SConsI18N.SConsProjectConfigureHandler_ConfiguringFailedErrorMessage,
                    e);
    ...
    private void saveProjectSettings(String wizardCmdOptions) {
        String workspaceOptions = SConsPlugin.getWorkspacePreferenceStore().getString(PreferenceConstants.ADDITIONAL_COMMANDLINE_OPTIONS);
        ...
        projectOptions.setValue(PreferenceConstants.BUILD_SETTINGS_PAGE_ID + PreferenceConstants.USE_PARENT_SUFFIX, false);
        try {
            projectOptions.save();
        } catch (Exception e) {
