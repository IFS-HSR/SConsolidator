...
public class CollectionUtilTest {
    ...
    public void testListWithElements() {
        ...
        assertTrue(list instanceof ArrayList<?>);
        assertArrayEquals(new String[] { "scons", "is", "better", "than", "cmake" }, list.toArray(new String[0]));
    }
    ...
    public void testSetWithElements() {
        ...
        assertTrue(set instanceof HashSet<?>);
        assertTrue(set.containsAll(Arrays.asList(new String[] { "scons", "is", "better", "than", "cmake" })));
    }
