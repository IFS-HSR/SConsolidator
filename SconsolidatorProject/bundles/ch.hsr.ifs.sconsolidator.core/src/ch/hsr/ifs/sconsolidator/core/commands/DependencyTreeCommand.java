...
public class DependencyTreeCommand extends SConsCommand {
    ...
    public DependencyTreeCommand(SConsConsole console, IProject project, String targetPath) throws EmptySConsPathException {
        this(null, console, project, targetPath);
    }

    public DependencyTreeCommand(String binaryPath, SConsConsole console, IProject project, String targetPath) throws EmptySConsPathException {
