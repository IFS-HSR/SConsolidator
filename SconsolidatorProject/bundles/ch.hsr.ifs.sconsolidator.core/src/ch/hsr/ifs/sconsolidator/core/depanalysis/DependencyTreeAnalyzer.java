...
public class DependencyTreeAnalyzer {
    ...
    public Collection<String> collectTargets(String sourcePath) {
        ...
        if (dependencyTree.isEmpty()) return Collections.emptyList();
    ...
    private Collection<DependencyTreeNode> search(String sourcePath, List<DependencyTreeNode> dependencyTree) {
    ...
    private Collection<DependencyTreeNode> findRelatedObjectFiles(List<DependencyTreeNode> foundSrcNodes) {
