...
public final class PreferenceConstants {
  ...
  public static final String BUILD_SETTINGS_PAGE_ID =
      "ch.hsr.sconsolidator.core.BuildSettingsPreferencePage";
  public static final String PERF_VS_ACCURACY_PAGE_ID =
      "ch.hsr.sconsolidator.core.PerformanceAccuracyPreferencePage";
  public static final String WARNINGS_PAGE_ID = "ch.hsr.sconsolidator.core.WarningsPreferencePage";
  public static final String EXECUTABLE_PATH_PAGE_ID =
      "ch.hsr.ifs.sconsolidator.core.ExecutablePathPreferencePage";
}
