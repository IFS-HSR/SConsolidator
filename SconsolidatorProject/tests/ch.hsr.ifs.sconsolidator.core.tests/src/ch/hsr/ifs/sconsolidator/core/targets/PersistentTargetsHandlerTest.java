...
public class PersistentTargetsHandlerTest {
    ...
    public void before() throws Exception {
        ...
        target = new SConsBuildTarget("CoastFoundationTest", project, "", "foundation tests", "--run-force");
    }
    ...
    public void testSaveTargets() throws CoreException {
        ...
        assertEquals(1, handler.getTargets().size());
        assertTrue(newHandler.getTargets().iterator().next().getTargetName().equals("CoastFoundationTest"));
    }
}
