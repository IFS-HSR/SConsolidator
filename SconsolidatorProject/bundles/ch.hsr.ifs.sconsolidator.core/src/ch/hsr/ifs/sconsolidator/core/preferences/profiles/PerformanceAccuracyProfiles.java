...
public enum PerformanceAccuracyProfiles {
    ...
    private static Map<String, PerformanceAccuracyProfiles> STRING_TO_ENUM = new HashMap<String, PerformanceAccuracyProfiles>();
    ...
    private PerformanceAccuracyProfiles(String name, String description, PerformanceAccuracyProfile profile) {
        this.name = name;
