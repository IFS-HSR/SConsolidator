...
public class BuildCommand extends SConsCommand {
    ...
    public BuildCommand(SConsConsole console, IProject project, String targetName, String additionalArgs) throws EmptySConsPathException {
        this(null, console, project, targetName, additionalArgs);
    }

    public BuildCommand(String binaryPath, SConsConsole console, IProject project, String targetName, String additionalArgs)
    ...
    private List<String> getDefaultTargets(IProject project) {
        return StringUtil.split(SConsPlugin.getProjectPreferenceStore(project).getString(DEFAULT_TARGET));
    }
