...
public class WarningsPreferencePage extends FieldEditorOverlayPage implements IWorkbenchPreferencePage {
    ...
    private void addStackSizeWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor stackSizeWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.STACK_SIZE_WARNINGS,
    ...
    private void addReservedVariableWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor reservedVariableWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.RESERVED_VARIABLE_WARNINGS,
    ...
    private void addNoPythonVersionWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor noPythonVersionWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.NO_PYTHON_VERSION_WARNINGS,
    ...
    private void addNoParallelSupportWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor noParallelSupportWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.NO_PARALLEL_SUPPORT_WARNINGS,
    ...
    private void addNoObjectCountWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor noObjectCountWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.NO_OBJECT_COUNT_WARNINGS,
    ...
    private void addNoMetaClassWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor noMetaClassWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.NO_META_CLASS_WARNINGS,
    ...
    private void addNoMd5ModuleWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor noMd5ModuleWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.NO_MD5_MODULE,
    ...
    private void addMissingSConscriptWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor missingSConscriptWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.MISSING_SCONSCRIPT_WARNING,
    ...
    private void addMisleadingKeywordsWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor misleadingKeywordsWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.MISLEADING_KEYWORD_WARNING,
    ...
    private void addLinkWarningsField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor linkWarnings = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.LINK_WARNING,
    ...
    private void addFutureDeprecatedWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor futureDeprecatedWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.FUTURE_DEPRECATED_WARNING,
    ...
    private void addFortranCppMixWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor fortranCppMixWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.FORTRAN_CPP_MIX_WARNING,
    ...
    private void addDuplicateEnvWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor duplicateEnvWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.DUPLICATE_ENV_WARNING,
    ...
    private void addDeprecatedTargetSignaturesWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor deprecatedTargetSignaturesWarning = new DependentBooleanFieldEditor(allWarnings,
                PreferenceConstants.DEPRECATED_TARGET_SIGNATURES, SConsI18N.WarningsPreferencePage_DeprecatedTargetSigWarning, parent);
    ...
    private void addDeprecatedSourceSignaturesWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor deprecatedSourceSignaturesWarning = new DependentBooleanFieldEditor(allWarnings,
                PreferenceConstants.DEPRECATED_SOURCE_SIGNATURES, SConsI18N.WarningsPreferencePage_DeprecatedSourceSigWarning, parent);
    ...
    private void addDeprecatedCopyWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor deprecatedCopyWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.DEPRECATED_COPY_WARNING,
    ...
    private void addDependencyWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor dependencyWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.DEPENDENCIES_WARNINGS,
    ...
    private void addCorruptSConsignWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor corruptSConsignWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.CORRUPT_SCONSIGN_WARNING,
    ...
    private void addCacheWriteErrorWarningField(BooleanFieldEditor allWarnings) {
        BooleanFieldEditor cacheWriteErrorWarning = new DependentBooleanFieldEditor(allWarnings, PreferenceConstants.CACHE_WRITE_ERROR_WARNING,
    ...
    private BooleanFieldEditor getAllWarningsField() {
        BooleanFieldEditor allWarnings = new BooleanFieldEditor(PreferenceConstants.ALL_WARNINGS_ENABLED,
