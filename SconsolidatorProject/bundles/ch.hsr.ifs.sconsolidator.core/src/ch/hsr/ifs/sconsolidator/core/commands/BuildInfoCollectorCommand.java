...
public class BuildInfoCollectorCommand extends SConsCommand {
    ...
    public BuildInfoCollectorCommand(SConsConsole console, IProject project) throws EmptySConsPathException {
        this(null, console, project);
    }

    public BuildInfoCollectorCommand(String binaryPath, SConsConsole console, IProject project) throws EmptySConsPathException {
