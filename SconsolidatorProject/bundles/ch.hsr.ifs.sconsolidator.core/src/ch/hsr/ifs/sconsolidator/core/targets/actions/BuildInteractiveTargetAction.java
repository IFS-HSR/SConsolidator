...
public class BuildInteractiveTargetAction extends AbstractBuildTargetAction {
    ...
    @Override
    protected void buildTargets(Collection<SConsBuildTarget> targets, IProgressMonitor pm) throws EmptySConsPathException, CoreException {
    ...
    @Override
    protected void buildProjects(Collection<IProject> projects, IProgressMonitor pm) throws EmptySConsPathException, CoreException {
