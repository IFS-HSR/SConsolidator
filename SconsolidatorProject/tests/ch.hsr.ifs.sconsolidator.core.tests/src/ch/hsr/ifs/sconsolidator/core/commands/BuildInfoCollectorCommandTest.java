...
public class BuildInfoCollectorCommandTest {
    ...
    public void setUp() throws Exception {
        existingCodeCommand = new BuildInfoCollectorCommand(getSConsPath(), new NullConsole(), testProject.getProject());
    }
    ...
    private void copyExtractorScript(File projectPath) throws CoreException {
        FileUtil.copyBundleFile(new Path("scons_files" + File.separator + SConsHelper.BUILD_INFO_COLLECTOR), projectPath.getAbsolutePath() +
                                                                                                             File.separator +
