...
public class SConsVersionTest {
  ...
  public void testMissingEnginePart() {
    String versionMissingEnginePart =
  ...
  public void testIsGreaterThan() {
    SConsVersion versionMajorOne =
        new SConsVersion("engine: v1.0.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionMajorTwo =
        new SConsVersion("engine: v2.0.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionMinorOne =
        new SConsVersion("engine: v2.1.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionMinorTwo =
        new SConsVersion("engine: v2.2.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionRevisionOne =
        new SConsVersion("engine: v2.2.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionRevisionTwo =
        new SConsVersion("engine: v2.2.2.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
  ...
  public void testIsGreaterOrEqual() {
    SConsVersion versionEqualOne =
        new SConsVersion("engine: v2.0.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionEqualTwo =
        new SConsVersion("engine: v2.0.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionRevisionOne =
        new SConsVersion("engine: v2.2.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionRevisionTwo =
  ...
  public void testIsCompatible() {
    SConsVersion versionZero =
        new SConsVersion("engine: v0.9.8.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
    SConsVersion versionTwo =
        new SConsVersion("engine: v2.2.1.r5134, 2010/08/16 23:02:40, by bdeegan on cooldog");
