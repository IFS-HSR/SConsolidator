...
public class ConfigureSConsFilesAction extends WorkspaceModifyOperation {
    ...
    protected void execute(IProgressMonitor pm) throws CoreException, InvocationTargetException, InterruptedException {
        if (doesSConstructExist() && !askUserToContinue()) throw new OperationCanceledException(
    ...
    private boolean askUserToContinue() {
        return MessageDialog.openConfirm(UIUtil.getWindowShell(), SConsI18N.DialogWarnUserAboutExistingSConstruct_Title,
