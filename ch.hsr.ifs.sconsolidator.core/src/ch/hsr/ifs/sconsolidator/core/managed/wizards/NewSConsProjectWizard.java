...
public class NewSConsProjectWizard extends AbstractCWizard {
	...
	protected IToolChain[] getExtensionToolchains() {
		return ManagedBuildManager.getExtensionsToolChains(MBSWizardHandler.ARTIFACT,
				ManagedBuildManager.BUILD_ARTEFACT_TYPE_PROPERTY_EXE, false);
	}
	...
	private SConsWizardHandler getHandler(IWizard wizard) {
		return new SConsWizardHandler(
				new SConsBuildPropertyValue(ManagedBuildManager.BUILD_ARTEFACT_TYPE_PROPERTY_EXE, CATEGORY_NAME), parent,
				wizard);
	}
}
