...
public class SConsOptionHandler {
    ...
    static {
        ...
        cmdOptions.put(PreferenceConstants.IMPLICIT_DEPS_CHANGED, from("--implicit-deps-changed", (String) null));
        cmdOptions.put(PreferenceConstants.IMPLICIT_DEPS_UNCHANGED, from("--implicit-deps-unchanged", (String) null));
    ...
    private void addNumOfJobsOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addSuppressBuildingMsgOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addSilentOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addRandomOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addIgnoreErrorsOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addKeepGoingOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addPerfAccuracyRelatedOptions(Map<String, String> dict, boolean isCmdLine) {
        IPreferenceStore preferences = SConsPlugin.getActivePreferences(project, PreferenceConstants.PERF_VS_ACCURACY_PAGE_ID);
    ...
    private void addMaxDriftOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences, Map<String, String> defaultSettings) {
    ...
    private void addChunkSizeOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences, Map<String, String> defaultSettings) {
    ...
    private void addStackSizeOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences, Map<String, String> defaultSettings) {
    ...
    private void addImplictDepsChangedOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addUseCacheOption(Map<String, String> dict, boolean isCmdLine, IPreferenceStore preferences) {
    ...
    private void addWarningFileOptions(Map<String, String> dict, boolean isCmdLine) {
        IPreferenceStore preferences = SConsPlugin.getActivePreferences(project, PreferenceConstants.WARNINGS_PAGE_ID);
    ...
    private String getOption(String optionName, boolean isCmdLine, int... value) {
        ...
        else if (isCmdLine) return _1(pair);
    ...
    public static String getNormalizedCommandLineOpts() {
        return PlatformSpecifics.expandEnvVariables(getAdditionalCmdLineArgs()).replaceAll(Pattern.quote(PlatformSpecifics.NEW_LINE), " ");
    }

    private static String getAdditionalCmdLineArgs() {
        return SConsPlugin.getWorkspacePreferenceStore().getString(PreferenceConstants.ADDITIONAL_COMMANDLINE_OPTIONS);
    }
}
