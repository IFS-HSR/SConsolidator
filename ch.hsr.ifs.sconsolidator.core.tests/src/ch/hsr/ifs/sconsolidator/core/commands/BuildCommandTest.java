...
public class BuildCommandTest {
  ...
  private static final String[] EXPECTED_ARGS = new String[] {
      String.format("--jobs=%d", SConsHelper.getNumOfPreferredJobs()), "-m", "-D"};
  ...
  public void testCreateWithoutTarget() throws Exception {
    buildCommand =
        new BuildCommand(getSConsPath(), new NullConsole(), testProject.getProject(), null,
  ...
  public void testCreateWithTarget() throws Exception {
    buildCommand =
        new BuildCommand(getSConsPath(), new NullConsole(), testProject.getProject(), "hello",
            ADDITIONAL_CMD_LINE_ARGS);
