...
public class DependencyTreeCollector {
    ...
    private IPath getAsciiTreePath(IProject project) {
        ...
        if (!asciiTreePath.toFile().exists()) throw new IllegalArgumentException("Project must have a dependency tree file");
    ...
    public String collectTargetDependencies() throws CoreException {
        ...
        try {
            ...
            IStatus status = new Status(IStatus.ERROR, SConsPlugin.PLUGIN_ID, 0, "Target dependencies could not be resolved", e);
