...
public class SConsManagedProjectHandler {
    ...
    public static final String     MANAGED_MAKE_BUILDER = "org.eclipse.cdt.managedbuilder.core.genmakebuilder";
    private final IProject         project;
    private final IProgressMonitor pm;

    public SConsManagedProjectHandler(IProject project, IProgressMonitor pm) {
        if (!hasDefaultConfig(project)) throw new IllegalArgumentException("Project must have a valid default configuration");
